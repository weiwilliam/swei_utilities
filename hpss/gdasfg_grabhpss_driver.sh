#!/bin/ksh
#SBATCH --output=/scratch1/BMC/gsd-fv3-dev/Shih-wei.Wei/wrklog/grab_gdasfg.out
#SBATCH --job-name=swei_gdasfg
#SBATCH --qos=batch
...
tarsuffix=gdas_nemsio

fsuffix_list="atmf003.nemsio atmf006.nemsio atmf009.nemsio \
         sfcf003.nemsio sfcf006.nemsio sfcf009.nemsio"
targetfiles=""
